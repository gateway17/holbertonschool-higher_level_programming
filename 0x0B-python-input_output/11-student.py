...
deserialization mechanism (concept of representation of an object
to another format, without losing any information and allow us to
rebuild an object based on this representation)
...
class Student:
    ...
    def reload_from_json(self, json):
        """Repleace atributes of intance, to new one (recived as argument)."""
        for e in json:
